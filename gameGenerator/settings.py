"""
Django settings for gameGenerator project.
...
SECRET_KEY = 'django-insecure-k-5n^7p6-6b=i_(g1#v0niu!^50*#bt=__3nu@h=-%7+ubvdzv'
...
ROOT_URLCONF = 'gameGenerator.urls'
...
WSGI_APPLICATION = 'gameGenerator.wsgi.application'
